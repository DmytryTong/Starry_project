...
from bar.forms import PositionSearchForm, GenreSearchForm, MusicianSearchForm, RockbandSearchForm, EventSearchForm, \
    VisitorCreationForm
from bar.models import Genre, Event, Rockband, Position, Musician, Visitor
